...
class COCO:
    ...
    def build(self, tarDir=None, tarFile='./new.json', N=1000, start=0):
...
coco = COCO('data/coco/annotations/instances_train2017_old.json',
            origin_img_dir='/root/mmdetection/data/coco/images/train2017')               # 完整的coco数据集的图片和标注的路径
coco.build('data/coco/split/images/train2017', 'data/coco/split/annotations/instances_train2017.json', 300, 0)  # 保存图片路径


coco = COCO('data/coco/annotations/instances_train2017_old.json',
            origin_img_dir='/root/mmdetection/data/coco/images/train2017')                 # 完整的coco数据集的图片和标注的路径
coco.build('data/coco/split/images/val2017', 'data/coco/split/annotations/instances_val2017.json', 110, 300)       # 保存图片路径
